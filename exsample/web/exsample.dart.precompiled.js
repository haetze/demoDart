...
["dart._collection.dev", "dart:_collection-dev", , H, {
  ...
  MappedIterable: {
    ...
    static: {MappedIterable_MappedIterable: function(iterable, $function, $S, $T) {
        var t1 = new H.EfficientLengthMappedIterable(iterable, $function);
...
["", "exsample.dart", , A, {
  main: function() {
    var t1, t2, t3;
    window.alert(H.S(window.closed));
    t1 = document.querySelector("#hi");
    t1.toString;
    t2 = C.EventStreamProvider_click._eventType;
    t3 = new W._ElementEventStreamImpl(t1, t2, false);
    H.setRuntimeTypeInfo(t3, [null]);
    t2 = new W._EventStreamSubscription(0, t1, t2, W._wrapZone(A.eventHandlerKey$closure), false);
    H.setRuntimeTypeInfo(t2, [H.getTypeArgumentByIndex(t3, 0)]);
    t2._tryResume$0();
    t2 = $.get$Soc();
    t2.toString;
    t3 = C.EventStreamProvider_open._eventType;
    t1 = new W._EventStream(t2, t3, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = new W._EventStreamSubscription(0, t2, t3, W._wrapZone(new A.main_closure()), false);
    H.setRuntimeTypeInfo(t3, [H.getTypeArgumentByIndex(t1, 0)]);
    t3._tryResume$0();
    t3 = $.get$Soc();
    t3.toString;
    t1 = C.EventStreamProvider_message._eventType;
    t2 = new W._EventStream(t3, t1, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t3, t1, W._wrapZone(new A.main_closure0()), false);
    H.setRuntimeTypeInfo(t1, [H.getTypeArgumentByIndex(t2, 0)]);
    t1._tryResume$0();
  },
  eventHandlerKey: function(e) {
    window.alert("got event " + H.S(e));
    $.get$Soc().send("from function");
  },
  main_closure: {
    "": "Closure;",
    call$1: function(e) {
  ...
  main_closure0: {
    "": "Closure;",
    call$1: function(e) {
      P.print(H.S(J.toString$0(J.get$data$x(e))));
      $.get$Soc().send("wq");
    },
    $is_args1: true
  }
...
init.globalFunctions.eventHandlerKey$closure = A.eventHandlerKey$closure = new P.Closure$1(A.eventHandlerKey, "eventHandlerKey$closure");
...
Isolate.$lazy($, "Soc", "Soc", "get$Soc", function() {
  return W.WebSocket_WebSocket("ws://127.0.0.1:9090", null);
});
// Native classes
